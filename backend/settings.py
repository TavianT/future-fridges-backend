...
ALLOWED_HOSTS = ['future-fridges.azurewebsites.net', 'localhost']
CSRF_TRUSTED_ORIGINS=['https://*future-fridges.azurewebsites.net','http://*future-fridges.azurewebsites.net']
